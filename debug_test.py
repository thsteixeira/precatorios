#!/usr/bin/env python
"""Debug script to test diligencia marking"""
import os
import django
...
if form.is_valid():
    ...
    print(f"  original diligencia.concluida: {diligencia.concluida}")
    ...
    if updated_diligencia.concluida:
        ...
        if not diligencia.concluida:  # Only set if wasn't completed before
