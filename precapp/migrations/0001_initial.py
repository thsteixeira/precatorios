# Generated by Django 3.1.12 on 2025-08-16 17:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.CharField(help_text='Nome da fase', max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fase', models.ForeignKey(blank=True, help_text='Fase atual do requerimento', null=True, on_delete=django.db.models.deletion.PROTECT, to='precapp.fase')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='precapp.cliente')),
                ('fase', models.ForeignKey(blank=True, help_text='Fase atual do alvará', null=True, on_delete=django.db.models.deletion.PROTECT, to='precapp.fase')),
                ('precatorio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='precapp.precatorio')),
            ],
        ),
    ]
