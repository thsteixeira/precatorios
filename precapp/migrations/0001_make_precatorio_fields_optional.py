# Generated by Django 3.1.12 on 2025-08-16 23:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_oficio', models.DateField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='alvara',
            name='fase',
            field=models.ForeignKey(blank=True, help_text='Fase atual do alvará', null=True, on_delete=django.db.models.deletion.PROTECT, to='precapp.fase'),
        ),
        migrations.AddField(
            model_name='alvara',
            name='precatorio',
