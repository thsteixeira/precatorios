"""
Custom S3 Storage Backend for Large File Handling
Enhanced with better multipart upload support and signed URL generation
"""
...
class LargeFileS3Storage(S3Boto3Storage):
    """
    Custom S3 storage optimized for large file uploads (50MB+)
